...
// import LineChart from "@/pages/Common/Line";
    ...
    import LineChart from '@/pages/Common/Line';
    // 引入三相警告api
    import { warnList, warnStates } from '@/api/safetyMonitor/phaseWarn';
        ...
        data () {
            return {
                ...
                options: {
                    ...
                    title: { show: true, text: '24小时三相报警情况' }
                },
                params: {
                    page: 1,
                    rows: 10,
                ...
                this.$nextTick(() => {
                    warnStates(this.params).then((res) => {
                        ...
                        if (this.params.dateType === 2) {
                            this.options.title.text = '当月三相报警情况';
                        } else {
                            this.options.title.text = '24小时三相报警情况';
                        }
